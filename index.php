...
$routes = [
  ...
  'POST /admin/login/username' => ['App\Controllers\Admin\AuthController', 'postUsername'],
  'POST /admin/login/password' => ['App\Controllers\Admin\AuthController', 'postPassword'],
  'POST /admin/login/key' => ['App\Controllers\Admin\AuthController', 'postKey'],
